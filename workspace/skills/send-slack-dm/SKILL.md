...
input_path: /tmp/compose-slack-reminder-message_${RUN_ID}.json
output_path: /tmp/send-slack-dm_${RUN_ID}.json
depends_on: [compose-slack-reminder-message, format-slack-daily-report]
---
...
- **Input:** `/tmp/compose-slack-reminder-message_${RUN_ID}.json` or `/tmp/format-slack-daily-report_${RUN_ID}.json`, with a JSON object like `{ "message_type": "reminder|daily_report", "text": "...", "ticket_count": 0, "send": true|false, "slack_user_id": "U123" }`.
