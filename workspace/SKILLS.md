...
| S5   | `compose-slack-reminder-message` | Compose Slack Reminder Message | Auto | Low | Builds a concise Slack DM reminder from matching Linear Todo tickets. |
...
compose-slack-reminder-message ← depends on fetch-linear-todo-tickets
format-slack-daily-report ← depends on fetch-linear-todo-tickets
send-slack-dm ← depends on compose-slack-reminder-message, format-slack-daily-report
```
